...
puts rabbit.bmi               # => 111.11
puts rabbit.dangerous?        # => false

snake = Animal.new("snake", 30, 1, true, 30)
puts snake.dangerous?         # => true
puts snake.daily_calories     # => 1076.76

elephant = Animal.new("elephant", 300, 3, false, 5)
puts elephant.bmi             # => 33.33
puts elephant.daily_calories  # => 6055.08

gazelle = Animal.new("gazelle", 50, 1.5, false, 100)
puts gazelle.daily_calories   # => 1579.45
puts gazelle.dangerous?       # => true
